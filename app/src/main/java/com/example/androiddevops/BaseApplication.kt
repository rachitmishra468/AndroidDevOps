...
import com.example.androiddevops.appfunctions.AppFunctions
...
abstract class BaseApplication : Application(), AppFunctionConfiguration.Provider {
...
@HiltAndroidApp
class AndroidDevOpsApplication : BaseApplication()
